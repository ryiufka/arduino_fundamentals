...
Nie musisz wiedzieć czym jest programowanie, czym jest elektronika, ani dlaczego ktoś wpadł na pomysł robić kabelki w tylu kolorach. **Nikt nie wie wszystkiego na początku.** Cała sztuka polega na tym, żeby spróbować i zobaczyć efekty na własne oczy.
...
Każdy projekt będzie bezpieczny, możliwy do zrobienia **bez lutowania**, i prosty do naprawy, jeśli coś pójdzie nie tak.
...
- **Wyświetlacze** — matryca LED 8x8 i ekran LCD (jak w bankomatach)
- **Odbiorniki IR i RFID** — technologia z pilotem i kartami dostępu
- **Przyciski, joystick, potencjometr** — narzędzia do sterowania
...
Jeśli coś nie działa — to nie znaczy, że zrobiłeś coś źle ani że „się do tego nie nadajesz".

Najczęściej: kabel jest w złym miejscu, coś nie jest wciśnięte, albo komputer się zastanawia.

**To normalne.** Każdy inżynier zaczynał od przewodów w złym miejscu. To część nauki.
...
Chodzi o to, żeby zobaczyć, że da się **budować rzeczywiste urządzenia za pomocą kilku kabelków, czujników i pomysłów**.
